...
vim.api.nvim_set_keymap('', '<leader>ots', '<cmd>botright sp +te<CR>i', {noremap=true})
vim.api.nvim_set_keymap('', '<leader>otv', '<cmd>botright vs +te<CR>i', {noremap=true})
vim.api.nvim_set_keymap('', '<leader>ott', '<cmd>tabe +te<CR>i', {noremap=true})
