...
Practical examples of commands designed for OpenCode plugins, demonstrating plugin-specific patterns and features.
...
**File:** `command/complete-review.md`
...
4. **Hardcoding plugin paths:**
   ...
   @/home/user/.config/opencode/plugins/my-plugin/config.json
