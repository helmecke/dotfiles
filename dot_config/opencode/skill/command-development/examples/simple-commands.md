...
**File:** `.opencode/command/security-review.md`
...
**File:** `.opencode/command/test-file.md`
...
**File:** `.opencode/command/document.md`
...
**File:** `.opencode/command/git-status.md`
...
**File:** `.opencode/command/compare-files.md`
...
**File:** `.opencode/command/quick-fix.md`
...
**File:** `.opencode/command/explain.md`
